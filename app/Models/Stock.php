...
class Stock
{
    ...
    public function __construct(
        ...
        float $year_high, float $volume, float $avgVolume, string $createdAt)
    {
        ...
        $this->open = $open;
        $this->bid = $bid;
        $this->bidSize = $bidSize*100;
        $this->ask = $ask;
        $this->askSize = $askSize*100;
    ...
    {
        return ($this->bid .' x '.$this->bidSize);
    }

    public function getAsk(): string
    {
        return ($this->ask .' x '.$this->askSize);
    }
